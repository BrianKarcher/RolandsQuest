...
namespace RQ.Editor
{
    [CustomEditor(typeof(SeesTargetCondition), true)]
    public class SeesTargetConditionEditor : EditorBase
    {
        private SeesTargetCondition agent;
        //private SceneSetup _sceneSetup;

        public void OnEnable()
        {
            agent = target as SeesTargetCondition;
