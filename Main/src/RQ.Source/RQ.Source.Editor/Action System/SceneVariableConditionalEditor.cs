...
namespace RQ.Editor
{
    [CustomEditor(typeof(SceneVariableConditional), true)]
    public class SceneVariableConditionalEditor : EditorBase
    {
        private SceneVariableConditional agent;
        private SceneSetup _sceneSetup;

        public void OnEnable()
        {
            agent = target as SceneVariableConditional;
