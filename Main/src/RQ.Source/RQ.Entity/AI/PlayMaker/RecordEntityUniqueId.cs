...
namespace Assets.Source.AI.PM_State_Machine
{
    ...
    public class RecordEntityUniqueId : FsmStateAction
    {
        [RequiredField]
        ...
        public override void OnEnter()
        {
            ...
            //if (!storeArray.IsNone && !storeArray.stringValues.Contains(uniqueId))
            if (!storeArray.IsNone && Array.IndexOf(storeArray.stringValues, uniqueId) == -1)
            {
