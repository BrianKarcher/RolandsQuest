...
namespace RQ.Common.Container
{
    public class EntityContainer : IEntityContainer
    {
        ...
        [HideInInspector]
        public static readonly EntityContainer _instance = new EntityContainer();
        ...
        public void AddEntity(IEntity entity)
        {
            ...
            EntityInstanceMap.Add(entity.UniqueId, entity);
        ...
        public void SetBossCharacter(IEntity repo)
        {
            ...
            IEntity boss;
            if (!Bosses.TryGetValue(repo.UniqueId, out boss))
                Bosses.Add(repo.UniqueId, repo);
            else
                boss = repo;
            //CompanionCharacter = repo;
        }
        ...
        {
            IEntity value;
            EntityInstanceMap.TryGetValue(id, out value);
        ...
        public void RemoveEntity(IEntity entity)
        {
            ...
            switch (entity.GetTag())
            {
                ...
                case "Companion":
                    ...
                    break;
                case "Boss":
                    if (Bosses.ContainsKey(entity.UniqueId))
            ...
            if (EntityInstanceMap.ContainsKey(entity.UniqueId))
                EntityInstanceMap.Remove(entity.UniqueId);
        }
