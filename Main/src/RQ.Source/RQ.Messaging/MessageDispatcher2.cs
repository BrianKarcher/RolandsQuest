...
namespace RQ.Messaging
{
    ...
    {
        internal class Events : Dictionary<long, Action<Telegram2>>
        {
        ...
        // Singleton instance
        public static readonly MessageDispatcher2 Instance = new MessageDispatcher2();
        ...
        private PriorityQueue<Telegram2> PriorityQ = new PriorityQueue<Telegram2>();
        ...
        public virtual long StartListening(string eventName, string id, Action<Telegram2> callbackMethod)
        {
        ...
        private bool Discharge(string receiverId, Telegram2 telegram)
        {
        ...
        private void Discharge(Events events, Telegram2 telegram)
        {
            if (events == null)
                return;
        ...
        public Telegram2 CreateTelegram(float delay,
                         string senderId,
                         string receiverId,
                         string eventName,
                         object ExtraInfo)
        {
            return new Telegram2(0, senderId, receiverId, eventName, ExtraInfo);
        }
        ...
        public Telegram2[] Serialize()
        {
            List<Telegram2> messageDatas = new List<Telegram2>();
        ...
        public void Deserialize(IEnumerable<Telegram2> messageDatas)
        {
            ...
            foreach (var messageData in messageDatas)
            {
                ...
                DispatchMsgWithEarlyTermination(messageData.EventName, messageData.TimeRemaining, messageData.SenderId,
                    messageData.ReceiverId, messageData.ExtraInfo);
            }
        }
    }
}
