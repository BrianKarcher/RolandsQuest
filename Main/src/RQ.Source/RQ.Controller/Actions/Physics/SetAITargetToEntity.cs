...
{
    [AddComponentMenu("RQ/Action/Physics/Set AI Target To Entity")]
    public class SetAITargetToEntity : ActionBase
    {
        public SetSteeringTargetToEntityAtom _atom;
        ...
        public override void Act(Component otherRigidBody)
        {
            ...
            // Send to self
            _atom.SendMessage(GetEntity().UniqueId);
