...
//        //        return ImportTMXXml(xml);
//        //    //}
//        //    //catch (System.Exception e) { return e.ToString(); }
//        //    //return "";
//        //}

//        string ImportTMX(string xml)
//        {
//            //try
//            //{
...
//            TileMap.TileMapUtility.ResizeTileMap(tileMap, width + extraWidth, height, tileMap.partitionSizeX, tileMap.partitionSizeY);
...
//            {
//                int index = TileMap.TileMapUtility.FindOrCreateLayer(tileMap, layer.name);
...
//        //    return Import(tileMap, path, format);
//        //}

//        public static bool Import(tk2dTileMap tileMap, string path, Format format)
//        {
//            var importer = new Importer();
...
//            //    path = EditorUtility.OpenFilePanel("Import tilemap", path, "tmx");
