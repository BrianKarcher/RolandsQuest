...
namespace tk2d
{
    ...
    /// </summary>
    public abstract class tk2dBaseSprite : MonoBehaviour, tk2dRuntime2.ISpriteCollectionForceBuild
    {
        /// <summary>
        /// Anchor.
        ...
        {
            tk2dSpriteCollectionData data = tk2dRuntime2.SpriteCollectionGenerator.CreateFromTexture(texture, size, region, anchor);
            if (data == null)
                return null;
