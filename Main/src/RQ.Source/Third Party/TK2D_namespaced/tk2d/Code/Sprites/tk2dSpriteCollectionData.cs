    ...
    public class tk2dSpriteCollectionData : MonoBehaviour
    {
        ...
        void Init()
        {
            ...
            if (materialInsts != null
                    ...
                    && materialInsts[0].shader.name.Contains("Premul"))
            { // Detect premultiplied textures
        ...
        {
            return tk2dRuntime2.SpriteCollectionGenerator.CreateFromTexture(texture, size, names, regions, anchors);
        }
        ...
        {
            return tk2dRuntime2.SpriteCollectionGenerator.CreateFromTexturePacker(size, texturePackerData, texture);
        }
