...
namespace tk2d
{
    ...
    /// Tile Map
    /// </summary>
    public class tk2dTileMap : MonoBehaviour, tk2dRuntime2.ISpriteCollectionForceBuild
    {
        /// <summary>
        ...
        void OnEnable()
        {
                ...
                && SpriteCollectionInst != null && SpriteCollectionInst.needMaterialInstance)
            {
                ...
                if (layers != null)
                {
                    foreach (tk2dRuntime2.TileMap.Layer layer in layers)
                    {
                        if (layer.spriteChannel != null && layer.spriteChannel.chunks != null)
                        {
                            foreach (tk2dRuntime2.TileMap.SpriteChunk chunk in layer.spriteChannel.chunks)
                            {
        ...
        /// </summary>
        public tk2dRuntime2.TileMap.TileInfo GetTileInfoForTileId(int tileId)
        {
