...
namespace tk2dEditor2.SpriteAnimationEditor
{
	public class ClipEditor
	{
		...
		// Editor operations
		public tk2dEditor2.SpriteAnimationEditor.AnimOperator[] animOps = new tk2dEditor2.SpriteAnimationEditor.AnimOperator[0];
		...
		void DrawClipInspector()
		{
			...
			foreach (tk2dEditor2.SpriteAnimationEditor.AnimOperator animOp in animOps)
			{
				...
				if ((animOp.AnimEditOperations & tk2dEditor2.SpriteAnimationEditor.AnimEditOperations.ClipContentChanged) != tk2dEditor2.SpriteAnimationEditor.AnimEditOperations.None)
				{
				 	RecalculateFrames();
				 	changed = true;
				}
				if ((animOp.AnimEditOperations & tk2dEditor2.SpriteAnimationEditor.AnimEditOperations.ClipNameChanged) != tk2dEditor2.SpriteAnimationEditor.AnimEditOperations.None)
				{
					OnClipNameChanged();
					changed = true;
				}
