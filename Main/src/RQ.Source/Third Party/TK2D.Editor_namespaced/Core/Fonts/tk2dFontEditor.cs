...
namespace tk2dEditor2
{
 ...
 || texture.format == TextureFormat.Alpha8
        ...
        bool ParseBMFont(string path, tk2dFontData fontData, tk2dFont source)
        {
            ...
            tk2dEditor2.Font.Info fontInfo = tk2dEditor2.Font.Builder.ParseBMFont(path);
            if (fontInfo != null)
                return tk2dEditor2.Font.Builder.BuildFont(fontInfo, fontData, scale, source.charPadX, source.dupeCaps, source.flipTextureY, source.gradientTexture, source.gradientCount);
            else
                return false;
        }
