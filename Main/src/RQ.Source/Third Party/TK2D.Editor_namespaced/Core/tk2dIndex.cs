...
namespace tk2dEditor2
{
    ...
    public class tk2dIndex : ScriptableObject
    {
        ...
        [SerializeField]
        List<tk2dGenericIndexItem> spriteAnimationIndex = new List<tk2dGenericIndexItem>();
        [SerializeField]
        List<tk2dGenericIndexItem> fontIndex = new List<tk2dGenericIndexItem>();
        [SerializeField]
        List<tk2dSpriteCollectionIndex> spriteCollectionIndex = new List<tk2dSpriteCollectionIndex>();
