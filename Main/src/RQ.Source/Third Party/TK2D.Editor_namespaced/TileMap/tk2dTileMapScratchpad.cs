...
namespace tk2dEditor2
{
    ...
    public class tk2dScratchpadGUI
    {
        ...
        public tk2dScratchpadGUI(tk2dTileMapSceneGUI _parent, tk2dEditor2.BrushRenderer _brushRenderer, tk2dTileMapEditorBrush _workingBrush)
        {
            parent = _parent;
