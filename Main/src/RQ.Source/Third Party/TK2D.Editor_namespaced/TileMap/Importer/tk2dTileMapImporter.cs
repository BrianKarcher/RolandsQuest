...
namespace tk2dEditor2.TileMap
{
	public class Importer
	{
		...
		void PopulateTilemap(tk2dTileMap tileMap)
		{
			...
			tk2dEditor2.TileMap.TileMapUtility.ResizeTileMap(tileMap, width + extraWidth, height, tileMap.partitionSizeX, tileMap.partitionSizeY);
			...
			{
				int index = tk2dEditor2.TileMap.TileMapUtility.FindOrCreateLayer(tileMap, layer.name);
