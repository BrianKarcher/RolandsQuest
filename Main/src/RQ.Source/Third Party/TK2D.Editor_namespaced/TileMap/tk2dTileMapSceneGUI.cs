...
namespace tk2dEditor2
{
    public class tk2dTileMapSceneGUI
    {
        ...
        tk2dEditor2.BrushRenderer brushRenderer = null;
        tk2dEditor2.BrushRenderer BrushRenderer
        {
            get
            {
                if (brushRenderer == null) brushRenderer = new tk2dEditor2.BrushRenderer(tileMap);
                ...
                if (rectX1 == rectX2 && rectY1 == rectY2)
                {
                    ...
                    for (int i = 0; i < nTiles; ++i)
                    {
                        ...
                        if (rot90)
                        {
                            ...
                            tx = ty;
                            ty = -tmp;
                            tk2dRuntime2.TileMap.BuilderUtil.SetRawTileFlag(ref spriteId, tk2dTileFlags.Rot90, true);
                        }
                        if (flipH)
                        {
                            tx = -tx;
                            tk2dRuntime2.TileMap.BuilderUtil.InvertRawTileFlag(ref spriteId, tk2dTileFlags.FlipX);
                        }
                        if (flipV)
                        {
                            ty = -ty;
                            tk2dRuntime2.TileMap.BuilderUtil.InvertRawTileFlag(ref spriteId, tk2dTileFlags.FlipY);
                        }
