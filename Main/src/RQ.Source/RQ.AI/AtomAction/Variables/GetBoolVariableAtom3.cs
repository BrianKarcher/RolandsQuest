...
{
    [Serializable]
    public class GetBoolVariableAtom3 : AtomActionBase
    {
        ...
        public override void Start(IComponentRepository entity)
        {
            ...
            if (_hudController == null)
                _hudController = GameController.Instance.UIManager.GetHudController();
            SetValue(Value);
        }
        ...
        private void SetValue(bool value)
        {
            ...
            switch (VariableToSet)
            {
                ...
                case BoolVariableEnum.IsKinematic:
                    ...
                    break;
                case BoolVariableEnum.Toggling:
                    _hudController.SetTogglingEnabled(value);
                    break;
                case BoolVariableEnum.IsCrafted:
                    GameStateController.Instance.IsCrafted = value;
                    break;
            }
        }
        ...
        private bool GetValue()
        {
            ...
            switch (VariableToSet)
            {
                ...
                case BoolVariableEnum.Toggling:
                    return _hudController.GetTogglingEnabled();
            }
            return false;
        }
