...
{
    public class ComponentRepository : MessagingObject, IComponentRepository
    {
        [SerializeField]
        ...
        private void DestroyComponents()
        {
            ...
            for (int i = 0; i < components.Count; i++)
            {
                ...
                if (MessageDispatcher2.Instance.IsListening("Kill", component.GetId()))
                    MessageDispatcher2.Instance.DispatchMsg("Kill", 0f, this.GetId(), component.GetId(), null);
            }
        }
